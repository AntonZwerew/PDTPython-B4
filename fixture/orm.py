...
class ORMFixture:
    ...
    def convert_contacts_to_model(self, contacts):
        def convert(contact):
            return Contact(contact_id=str(contact.id), first_name=contact.first_name, last_name=contact.last_name)
    ...
    def get_contact_list(self):
        return self.convert_contacts_to_model(select(c for c in ORMFixture.Contact if c.deprecated is None))
